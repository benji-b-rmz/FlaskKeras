...
# an image url for the number 1
# https://cdn1.thehunt.com/app/public/system/note_images/2978532/note_view/87c3c5b0b9781ea50e877c049cd1e980.png
...
# print(expanded_dim_img)
output_test = loaded_model.predict(np.expand_dims(expanded_dim_img, axis=0))
